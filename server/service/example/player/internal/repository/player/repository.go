...
// NewRecord -
func (r *Repository) NewRecord() *record.Player {
	return &record.Player{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.Player {
	return []*record.Player{}
}

// GetOne -
func (r *Repository) GetOne(id string, forUpdate bool) (*record.Player, error) {
	rec := r.NewRecord()
...
func (r *Repository) GetMany(
	...
	forUpdate bool) ([]*record.Player, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.Player) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.Player) error {
...
func (r *Repository) CreateTestRecord(rec *record.Player) error {

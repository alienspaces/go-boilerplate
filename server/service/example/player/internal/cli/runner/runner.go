...
import (
	...
	command "gitlab.com/alienspaces/go-mono-api-boilerplate/server/core/cli"
...
func (rnr *Runner) TestCommand(c *cli.Context) error {
	...
	rnr.Log.Info("** Player Test Command **")

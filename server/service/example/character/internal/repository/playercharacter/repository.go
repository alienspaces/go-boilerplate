...
// NewRecord -
func (r *Repository) NewRecord() *record.PlayerCharacter {
	return &record.PlayerCharacter{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.PlayerCharacter {
	return []*record.PlayerCharacter{}
}

// GetOne -
func (r *Repository) GetOne(id string, forUpdate bool) (*record.PlayerCharacter, error) {
	rec := r.NewRecord()
...
func (r *Repository) GetMany(
	...
	forUpdate bool) ([]*record.PlayerCharacter, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.PlayerCharacter) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.PlayerCharacter) error {
...
func (r *Repository) CreateTestRecord(rec *record.PlayerCharacter) error {
